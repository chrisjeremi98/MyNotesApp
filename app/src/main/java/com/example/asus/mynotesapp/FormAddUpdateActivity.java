...
public class FormAddUpdateActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public static String EXTRA_POSITION = "extra_note" ;
    public static String EXTRA_NOTE = "extra_position";

    public boolean isEdit = false;
    public static int REQIEST_ADD = 100;
    ...
    private void showAlertDialog(int alert) {
        final boolean isDialogClose = alert == ALERT_DIALOG_CLOSE;
                ...
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (isDialogClose) {
                            ...
                            Intent intent = new Intent();
                            intent.putExtra(EXTRA_POSITION, intent);
